vancouver_west_neighbourhoods = ['arbutus', 'cambie','coal-harbour','downtown-west','dunbar',
'fairview','false-creek','kerrisdale','kitsilano','mackenzie-heights','marpole',
'mount-pleasant-west','oakridge','point-grey','quilchena','shaughnessy','south-cambie',
'south-granville','southlands','southwest-marine','university-ubc','west-end','yaletown',] 

vancouver_west_neighbourhoods_part1 = ['arbutus', 'cambie','coal-harbour','downtown-west','dunbar',
'fairview','false-creek','kerrisdale','kitsilano','mackenzie-heights','marpole',
